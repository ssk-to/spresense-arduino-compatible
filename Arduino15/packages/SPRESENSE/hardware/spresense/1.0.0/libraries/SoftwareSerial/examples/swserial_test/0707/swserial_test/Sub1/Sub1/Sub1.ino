...
//#define SWSERIAL_BAUDRATE  9600
//#define SWSERIAL_BAUDRATE  57600
//#define SWSERIAL_BAUDRATE  115200 /* NG */
#define SWSERIAL_BAUDRATE  38400 /* OK */
//#define SWSERIAL_BAUDRATE  200000
//#define SWSERIAL_BAUDRATE  230400
...
void loop()
{
  ...
  if(!(ret = mutex.Trylock()))
    ...
    while(1)
      {
        ret = MP.Recv(&msgid, &addr);
        if(ret == MSG_ID_DATAOK)
          {
            MPLog("MSG_ID_DATAOK received\n");
            break;
          }
      }
#endif      
